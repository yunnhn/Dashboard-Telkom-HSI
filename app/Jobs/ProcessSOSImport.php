    ...
    private function processNewPos(string $batchId)
    {
        ...
        SELECT
            ...
            CASE
                ...
                WHEN raw.bill_witel IN ('JATIM TIMUR', 'SIDOARJO') AND (LOWER(raw.billcity) LIKE '%pasuruan%' OR LOWER(raw.billcity) LIKE '%probolinggo%' OR LOWER(raw.billcity) LIKE '%lumajang%') THEN 'I WAYAN KRISNA'
                WHEN raw.bill_witel IN ('JATIM TIMUR', 'SIDOARJO') AND (LOWER(raw.billcity) LIKE '%jember%' OR LOWER(raw.billcity) LIKE '%banyuwangi%' OR LOWER(raw.billcity) LIKE '%bondowoso%' OR LOWER(raw.billcity) LIKE '%situbondo%') THEN 'ILHAM MIFTAHUL'
                WHEN raw.bill_witel IN ('JATIM TIMUR', 'SIDOARJO') AND (LOWER(raw.billcity) LIKE '%gresik%' OR LOWER(raw.billcity) LIKE '%mojokerto%' OR LOWER(raw.billcity) LIKE '%sidoarjo%' OR LOWER(raw.billcity) LIKE '%jombang%') THEN 'IBRAHIM MUHAMMAD'
                WHEN raw.bill_witel IN ('JATIM BARAT', 'MALANG') AND (LOWER(raw.billcity) LIKE '%madiun%' OR LOWER(raw.billcity) LIKE '%ngawi%' OR LOWER(raw.billcity) LIKE '%bojonegoro%' OR LOWER(raw.billcity) LIKE '%tuban%' OR LOWER(raw.billcity) LIKE '%magetan%' OR LOWER(raw.billcity) LIKE '%ponorogo%') THEN 'ALFONSUS'
                WHEN raw.bill_witel IN ('JATIM BARAT', 'MALANG') AND (LOWER(raw.billcity) LIKE '%kediri%' OR LOWER(raw.billcity) LIKE '%nganjuk%' OR LOWER(raw.billcity) LIKE '%blitar%' OR LOWER(raw.billcity) LIKE '%trenggalek%' OR LOWER(raw.billcity) LIKE '%tulungagung%') THEN 'LUQMAN KURNIAWAN'
                WHEN raw.bill_witel IN ('JATIM BARAT', 'MALANG') AND (LOWER(raw.billcity) LIKE '%malang%' OR LOWER(raw.billcity) LIKE '%batu%' OR LOWER(raw.billcity) LIKE '%kepanjen%') THEN 'NURTRIA IMAN'
                WHEN raw.bill_witel = 'NUSA TENGGARA' AND (LOWER(raw.billcity) LIKE '%atambua%' OR LOWER(raw.billcity) LIKE '%ende%' OR LOWER(raw.billcity) LIKE '%kupang%' OR LOWER(raw.billcity) LIKE '%laboan bajo%' OR LOWER(raw.billcity) LIKE '%maumere%' OR LOWER(raw.billcity) LIKE '%waikabubak%' OR LOWER(raw.billcity) LIKE '%waingapu%' OR LOWER(raw.billcity) LIKE '%sikka%' OR LOWER(raw.billcity) LIKE '%ntt%' OR LOWER(raw.billcity) LIKE '%kefamenanu%' OR LOWER(raw.billcity) LIKE '%sabu raijua%' OR LOWER(raw.billcity) LIKE '%nagekeo%') THEN 'MARIA FRANSISKA'
                WHEN raw.bill_witel = 'NUSA TENGGARA' AND (LOWER(raw.billcity) LIKE '%bima%' OR LOWER(raw.billcity) LIKE '%sumbawa%' OR LOWER(raw.billcity) LIKE '%lombok%' OR LOWER(raw.billcity) LIKE '%mataram%' OR LOWER(raw.billcity) LIKE '%nusa tenggara barat%' OR LOWER(raw.billcity) LIKE '%dompu%' OR LOWER(raw.billcity) LIKE '%manggarai%') THEN 'ANDRE YANA'
